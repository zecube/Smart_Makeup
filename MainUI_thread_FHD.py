...
class Ui_MainWindow(object):
    ...
    def setupUiOff(self, MainWindow):
        ...
        self.time.setGeometry(QRect(787,577,375,45))    #(x,y, 가로, 높이)
        self.time.setObjectName("time")
        #setFont(QtGui.QFont("Font_name",Font_size))
        self.time.setFont(QFont("맑은 고딕",35)) 

        #날짜 label [년/월/일]
        self.date = QLabel(self.centralwidget)
        self.date.setGeometry(QRect(842, 495, 225, 38))
        ...
        self.DisplayOn.setGeometry(QRect(1860,555,60,60))
    ...
    def setupUiOn(self, MainWindow):
        ...
        # 시간 label [(오전/오후)시/분]
        self.time = QLabel(self.centralwidget)
        self.time.setGeometry(QRect(22,862,600,45))    #(x,y, 가로, 높이)
        self.time.setObjectName("time")
        #setFont(QtGui.QFont("Font_name",Font_size))
        self.time.setFont(QFont("맑은 고딕",35)) 
        ...
        #날짜 label [년/월/일]
        self.date = QLabel(self.centralwidget)
        self.date.setGeometry(QRect(165, 825, 225, 37))
        self.date.setObjectName("date")
        self.date.setFont(QFont("맑은 고딕",15))
        ...
        self.weather.setGeometry(QRect(90, 37, 100,100))
        self.weather.setObjectName("weather")

        #온도 label [온도 출력]
        self.temperature = QLabel(self.centralwidget)
        self.temperature.setGeometry(QRect(60, 120, 225,97))
        self.temperature.setObjectName("temperature")
        self.temperature.setFont(QFont("맑은 고딕",15))
        ...
        self.toggWidget.setGeometry(QRect(1800,825,100,60))
        ...
        # self.face.setGeometry(QRect(600, 150, 600,750))
        self.face.setGeometry(QRect(575, 125, 650,800))
        ...
        self.face_make.setGeometry(QRect(578, 128, 644,794))
        ...
        self.face_maketabextendedWidth = 551
        self.face_makeTab.setGeometry(QRect(1237, 225, self.face_maketabbaseWidth,600))
        self.face_makeTab.setStyleSheet("QTabWidget::pane { background-color: #FF6666; border: 3px; solid orange; }"
                                "QTabBar::tab { background-color: #FF9999; border: 3px; solid orange; color: #FFFFFF; width: 75px; height: 22px;}"
                                "QTabBar::tab:selected { background-color: #FF6666; color: #FFFFFF; width: 75px; height: 22px;}")
        ...
        self.skin_gb_1.setFont(QFont("맑은 고딕",11,QFont.Bold))
        ...
        self.skin_gb_1.setFixedHeight(375)

        self.SkinColor1 = QPushButton()
        self.SkinColor1.setMaximumHeight(225)
        ...
        self.SkinColor2.setMaximumHeight(225)
        ...
        self.SkinColor3.setMaximumHeight(225)
        ...
        self.SkinColor4.setMaximumHeight(225)
        ...
        self.SkinColor5.setMaximumHeight(225)
        ...
        self.skin_gb_2.setFont(QFont("맑은 고딕",11,QFont.Bold))
        ...
        self.s_DOWN.setMaximumHeight(37)
        self.s_DOWN.setMaximumWidth(37)
        
        self.s_DOWN.setIcon(left_arrow)
        self.s_DOWN.setIconSize(QSize(22,22)) # 아이콘 크기 설정
        self.s_DOWN.setStyleSheet("QPushButton { background-color: #FFFFFF; border-radius: 18px; }")

        self.s_Blending = QSlider(Qt.Horizontal)
        self.s_Blending.setMaximumHeight(37)
        self.s_Blending.setMaximumWidth(262)
        self.s_Blending.setStyleSheet("QSlider::groove:horizontal { border: 2px solid grey; background: #FF9999; height: 22px; margin: 2px 0;}"
        ...
        self.s_UP.setMaximumHeight(37)
        self.s_UP.setMaximumWidth(37)
        self.s_UP.clicked.connect(self.s_UpVal)
        self.s_UP.setIcon(right_arrow)
        self.s_UP.setIconSize(QSize(22,22)) # 아이콘 크기 설정
        self.s_UP.setStyleSheet("QPushButton { background-color: #FFFFFF; border-radius: 18px;}")
        ...
        self.mouth_gb_1.setFont(QFont("맑은 고딕",11,QFont.Bold))
        ...
        self.mouth_gb_1.setFixedHeight(375)

        self.MouthColor1 = QPushButton()
        self.MouthColor1.setMaximumHeight(225)
        ...
        self.MouthColor2.setMaximumHeight(225)
        ...
        self.MouthColor3.setMaximumHeight(225)
        ...
        self.MouthColor4.setMaximumHeight(225)
        ...
        self.MouthColor5.setMaximumHeight(225)
        ...
        self.mouth_gb_2.setFont(QFont("맑은 고딕",11,QFont.Bold))
        ...
        self.m_DOWN.setMaximumHeight(37)
        self.m_DOWN.setMaximumWidth(37)
        # self.m_DOWN.setText("DOWN")
        self.m_DOWN.setIcon(left_arrow)
        self.m_DOWN.setIconSize(QSize(22,22)) # 아이콘 크기 설정
        self.m_DOWN.setStyleSheet("QPushButton { background-color: #FFFFFF; border-radius: 18px;}")
        

        self.m_Blending = QSlider(Qt.Horizontal,self.addMouthWidjet)
        self.m_Blending.setMaximumHeight(37)
        self.m_Blending.setMaximumWidth(262)
        self.m_Blending.valueChanged.connect(self.m_Blendingval)
        self.m_Blending.setStyleSheet("QSlider::groove:horizontal { border: 2px solid grey; background: #FF9999; height: 22px; margin: 2px 0;}"
                                    "QSlider::handle:horizontal { background: white; width: 20px; margin: -2px 0; border-radius: 3px;}")

        self.m_UP = QPushButton(self.addMouthWidjet)
        self.m_UP.setMaximumHeight(37)
        self.m_UP.setMaximumWidth(37)
        self.m_UP.clicked.connect(self.m_UpVal)
        # self.m_UP.setText("UP")
        self.m_UP.setIcon(right_arrow)
        self.m_UP.setIconSize(QSize(22,22)) # 아이콘 크기 설정
        self.m_UP.setStyleSheet("QPushButton { background-color: #FFFFFF; border-radius: 18px;}")
        ...
        self.eye_gb_1.setFont(QFont("맑은 고딕",11,QFont.Bold))
        ...
        self.e_DOWN.setMaximumHeight(37)
        self.e_DOWN.setMaximumWidth(37)
        self.e_DOWN.setIcon(left_arrow)
        self.e_DOWN.setIconSize(QSize(22,22)) # 아이콘 크기 설정
        self.e_DOWN.setStyleSheet("QPushButton { background-color: #FFFFFF; border-radius: 18px;}")

        self.e_Blending = QSlider(Qt.Horizontal)
        self.e_Blending.valueChanged.connect(self.e_Blendingval)
        self.e_Blending.setMaximumHeight(37)
        self.e_Blending.setMaximumWidth(262)
        self.e_Blending.setStyleSheet("QSlider::groove:horizontal { border: 2px solid grey; background: #FF9999; height: 22px; margin: 2px 0;}"
                                    "QSlider::handle:horizontal { background: white; width: 20px; margin: -2px 0; border-radius: 3px;}")

        self.e_UP = QPushButton()
        self.e_UP.clicked.connect(self.e_UpVal)
        self.e_UP.setMaximumHeight(37)
        self.e_UP.setMaximumWidth(37)
        self.e_UP.setIcon(right_arrow)
        self.e_UP.setIconSize(QSize(22,22)) # 아이콘 크기 설정
        self.e_UP.setStyleSheet("QPushButton { background-color: #FFFFFF; border-radius: 18px;}")
        ...
        self.eye_gb_3.setFont(QFont("맑은 고딕",11,QFont.Bold))
        ...
        self.xpos_DOWN.setMaximumHeight(37)
        self.xpos_DOWN.setMaximumWidth(37)
        self.posx = 0
        self.xpos_DOWN.setIcon(left_arrow)
        self.xpos_DOWN.setIconSize(QSize(22,22)) # 아이콘 크기 설정
        self.xpos_DOWN.setStyleSheet("QPushButton { background-color: #FFFFFF; border-radius: 18px;}")

        self.dyxSlider = QSlider(Qt.Horizontal)
        self.dyxSlider.setValue(50)
        self.dyxSlider.valueChanged.connect(self.dyxVal)
        self.dyxSlider.setMaximumHeight(37)
        self.dyxSlider.setMaximumWidth(262)
        self.dyxSlider.setStyleSheet("QSlider::groove:horizontal { border: 2px solid grey; background: #FF9999; height: 22px; margin: 2px 0;}"
                                    "QSlider::handle:horizontal { background: white; width: 20px; margin: -2px 0; border-radius: 3px;}")

        self.xpos_UP = QPushButton()
        self.xpos_UP.clicked.connect(self.xpos_UPVal)
        self.xpos_UP.setMaximumHeight(37)
        self.xpos_UP.setMaximumWidth(37)
        self.xpos_UP.setIcon(right_arrow)
        self.xpos_UP.setIconSize(QSize(22,22)) # 아이콘 크기 설정
        self.xpos_UP.setStyleSheet("QPushButton { background-color: #FFFFFF; border-radius: 18px;}")

        self.eye_gb_4 = QGroupBox()
        self.eye_gb_4.setTitle("Pos y")
        self.eye_gb_4.setStyleSheet('color: #FFFFFF;')
        self.eye_gb_4.setFont(QFont("맑은 고딕",11,QFont.Bold))
        ...
        self.ypos_DOWN.setMaximumHeight(37)
        self.ypos_DOWN.setMaximumWidth(37)
        self.ypos_DOWN.setIcon(left_arrow)
        self.ypos_DOWN.setIconSize(QSize(22,22)) # 아이콘 크기 설정
        self.ypos_DOWN.setStyleSheet("QPushButton { background-color: #FFFFFF; border-radius: 18px;}")

        self.dyySlider = QSlider(Qt.Horizontal)
        self.dyySlider.setValue(50)
        self.dyySlider.valueChanged.connect(self.dyyVal)
        self.dyySlider.setMaximumHeight(37)
        self.dyySlider.setMaximumWidth(262)
        self.dyySlider.setStyleSheet("QSlider::groove:horizontal { border: 2px solid grey; background: #FF9999; height: 22px; margin: 2px 0;}"
                                    "QSlider::handle:horizontal { background: white; width: 20px; margin: -2px 0; border-radius: 3px;}")

        self.ypos_UP = QPushButton()
        self.ypos_UP.clicked.connect(self.ypos_UPVal)
        self.ypos_UP.setMaximumHeight(37)
        self.ypos_UP.setMaximumWidth(37)
        self.ypos_UP.setIcon(right_arrow)
        self.ypos_UP.setIconSize(QSize(22,22)) # 아이콘 크기 설정
        self.ypos_UP.setStyleSheet("QPushButton { background-color: #FFFFFF; border-radius: 18px;}")
        ...
        self.eye_gb_5.setFont(QFont("맑은 고딕",11,QFont.Bold))
        ...
        self.length_DOWN.setMaximumHeight(37)
        self.length_DOWN.setMaximumWidth(37)
        self.length_DOWN.setIcon(left_arrow)
        self.length_DOWN.setIconSize(QSize(22,22)) # 아이콘 크기 설정
        self.length_DOWN.setStyleSheet("QPushButton { background-color: #FFFFFF; border-radius: 18px;}")

        self.lengthSlider = QSlider(Qt.Horizontal)
        self.lengthSlider.valueChanged.connect(self.lengthVal)
        self.lengthSlider.setMaximumHeight(37)
        self.lengthSlider.setMaximumWidth(262)
        self.lengthSlider.setStyleSheet("QSlider::groove:horizontal { border: 2px solid grey; background: #FF9999; height: 22px; margin: 2px 0;}"
                                    "QSlider::handle:horizontal { background: white; width: 20px; margin: -2px 0; border-radius: 3px;}")

        self.length_UP = QPushButton()
        self.length_UP.clicked.connect(self.length_UPVal)
        self.length_UP.setMaximumHeight(37)
        self.length_UP.setMaximumWidth(37)
        self.length_UP.setIcon(right_arrow)
        self.length_UP.setIconSize(QSize(22,22)) # 아이콘 크기 설정
        self.length_UP.setStyleSheet("QPushButton { background-color: #FFFFFF; border-radius: 18px;}")
        ...
        self.cheek_gb_1.setFont(QFont("맑은 고딕",11,QFont.Bold))
        ...
        self.cheek_gb_2.setFont(QFont("맑은 고딕",11,QFont.Bold))
        ...
        self.c_DOWN.setMaximumHeight(36)
        self.c_DOWN.setMaximumWidth(36)
        self.c_DOWN.setIcon(left_arrow)
        self.c_DOWN.setIconSize(QSize(22,22)) # 아이콘 크기 설정
        self.c_DOWN.setStyleSheet("QPushButton { background-color: #FFFFFF; border-radius: 17px;}")

        self.c_Blending = QSlider(Qt.Horizontal)
        self.c_Blending.valueChanged.connect(self.c_Blendingval)
        self.c_Blending.setMaximumHeight(36)
        self.c_Blending.setMaximumWidth(261)
        self.c_Blending.setStyleSheet("QSlider::groove:horizontal { border: 2px solid grey; background: #FF9999; height: 22px; margin: 2px 0;}"
                                    "QSlider::handle:horizontal { background: white; width: 20px; margin: -2px 0; border-radius: 3px;}")

        self.c_UP = QPushButton()
        self.c_UP.clicked.connect(self.c_UpVal)
        self.c_UP.setMaximumHeight(36)
        self.c_UP.setMaximumWidth(36)
        self.c_UP.setIcon(right_arrow)
        self.c_UP.setIconSize(QSize(22,22)) # 아이콘 크기 설정
        self.c_UP.setStyleSheet("QPushButton { background-color: #FFFFFF; border-radius: 17px;}")
        ...
        self.cheek_gb_3.setFont(QFont("맑은 고딕",11,QFont.Bold))
        ...
        self.c_xpos_DOWN.setMaximumHeight(36)
        self.c_xpos_DOWN.setMaximumWidth(36)
        self.c_xpos_DOWN.setIcon(left_arrow)
        self.c_xpos_DOWN.setIconSize(QSize(22,22)) # 아이콘 크기 설정
        self.c_xpos_DOWN.setStyleSheet("QPushButton { background-color: #FFFFFF; border-radius: 17px;}")

        self.c_dyxSlider = QSlider(Qt.Horizontal)
        self.c_dyxSlider.setValue(50)
        self.c_dyxSlider.valueChanged.connect(self.c_dyxVal)
        self.c_dyxSlider.setMaximumHeight(36)
        self.c_dyxSlider.setMaximumWidth(261)
        self.c_dyxSlider.setStyleSheet("QSlider::groove:horizontal { border: 2px solid grey; background: #FF9999; height: 22px; margin: 2px 0;}"
                                    "QSlider::handle:horizontal { background: white; width: 20px; margin: -2px 0; border-radius: 3px;}")

        self.c_xpos_UP = QPushButton()
        self.c_xpos_UP.clicked.connect(self.c_xpos_UPVal)
        self.c_xpos_UP.setMaximumHeight(36)
        self.c_xpos_UP.setMaximumWidth(36)
        self.c_xpos_UP.setIcon(right_arrow)
        self.c_xpos_UP.setIconSize(QSize(22,22)) # 아이콘 크기 설정
        self.c_xpos_UP.setStyleSheet("QPushButton { background-color: #FFFFFF; border-radius: 17px;}")
        ...
        self.cheek_gb_4.setFont(QFont("맑은 고딕",11,QFont.Bold))
        ...
        self.c_ypos_DOWN.setMaximumHeight(36)
        self.c_ypos_DOWN.setMaximumWidth(36)
        self.c_ypos_DOWN.setIcon(left_arrow)
        self.c_ypos_DOWN.setIconSize(QSize(22,22)) # 아이콘 크기 설정
        self.c_ypos_DOWN.setStyleSheet("QPushButton { background-color: #FFFFFF; border-radius: 17px;}")

        self.c_dyySlider = QSlider(Qt.Horizontal)
        self.c_dyySlider.setValue(50)
        self.c_dyySlider.valueChanged.connect(self.c_dyyVal)
        self.c_dyySlider.setMaximumHeight(36)
        self.c_dyySlider.setMaximumWidth(261)
        self.c_dyySlider.setStyleSheet("QSlider::groove:horizontal { border: 2px solid grey; background: #FF9999; height: 22px; margin: 2px 0;}"
                                    "QSlider::handle:horizontal { background: white; width: 20px; margin: -2px 0; border-radius: 3px;}")

        self.c_ypos_UP = QPushButton()
        self.c_ypos_UP.clicked.connect(self.c_ypos_UPVal)
        self.c_ypos_UP.setMaximumHeight(36)
        self.c_ypos_UP.setMaximumWidth(36)
        self.c_ypos_UP.setIcon(right_arrow)
        self.c_ypos_UP.setIconSize(QSize(22,22)) # 아이콘 크기 설정
        self.c_ypos_UP.setStyleSheet("QPushButton { background-color: #FFFFFF; border-radius: 17px;}")
        ...
        self.cheek_gb_5.setFont(QFont("맑은 고딕",11,QFont.Bold))
        ...
        self.c_width_DOWN.setMaximumHeight(36)
        self.c_width_DOWN.setMaximumWidth(36)
        self.c_width_DOWN.setIcon(left_arrow)
        self.c_width_DOWN.setIconSize(QSize(22,22)) # 아이콘 크기 설정
        self.c_width_DOWN.setStyleSheet("QPushButton { background-color: #FFFFFF; border-radius: 17px;}")

        self.c_widthSlider = QSlider(Qt.Horizontal)
        self.c_widthSlider.valueChanged.connect(self.c_widthVal)
        self.c_widthSlider.setMaximumHeight(36)
        self.c_widthSlider.setMaximumWidth(261)
        self.c_widthSlider.setStyleSheet("QSlider::groove:horizontal { border: 2px solid grey; background: #FF9999; height: 22px; margin: 2px 0;}"
                                    "QSlider::handle:horizontal { background: white; width: 20px; margin: -2px 0; border-radius: 3px;}")

        self.c_width_UP = QPushButton()
        self.c_width_UP.clicked.connect(self.c_width_UPVal)
        self.c_width_UP.setMaximumHeight(36)
        self.c_width_UP.setMaximumWidth(36)
        self.c_width_UP.setIcon(right_arrow)
        self.c_width_UP.setIconSize(QSize(22,22)) # 아이콘 크기 설정
        self.c_width_UP.setStyleSheet("QPushButton { background-color: #FFFFFF; border-radius: 17px;}")
        ...
        self.cheek_gb_6.setFont(QFont("맑은 고딕",11,QFont.Bold))
        ...
        self.c_height_DOWN.setMaximumHeight(36)
        self.c_height_DOWN.setMaximumWidth(36)
        self.c_height_DOWN.setIcon(left_arrow)
        self.c_height_DOWN.setIconSize(QSize(22,22)) # 아이콘 크기 설정
        self.c_height_DOWN.setStyleSheet("QPushButton { background-color: #FFFFFF; border-radius: 17px;}")

        self.c_heightSlider = QSlider(Qt.Horizontal)
        self.c_heightSlider.valueChanged.connect(self.c_heightVal)
        self.c_heightSlider.setMaximumHeight(36)
        self.c_heightSlider.setMaximumWidth(261)
        self.c_heightSlider.setStyleSheet("QSlider::groove:horizontal { border: 2px solid grey; background: #FF9999; height: 22px; margin: 2px 0;}"
                                    "QSlider::handle:horizontal { background: white; width: 20px; margin: -2px 0; border-radius: 3px;}")

        self.c_height_UP = QPushButton()
        self.c_height_UP.clicked.connect(self.c_height_UPVal)
        self.c_height_UP.setMaximumHeight(36)
        self.c_height_UP.setMaximumWidth(36)
        self.c_height_UP.setIcon(right_arrow)
        self.c_height_UP.setIconSize(QSize(22,22)) # 아이콘 크기 설정
        self.c_height_UP.setStyleSheet("QPushButton { background-color: #FFFFFF; border-radius: 17px;}")
        ...
        self.savebtn.setGeometry(QRect(1237,832,75,37))
        ...
        self.saveloadextendedWidth = 225

        self.saveWidget = QWidget(self.centralwidget)
        self.saveWidget.setGeometry(QRect(1312,825, self.saveloadbaseWidth, 135))
        ...
        self.loadbtn.setGeometry(QRect(1237,880,75,37))
        ...
        self.loadWidget.setGeometry(QRect(1312,825, self.saveloadbaseWidth, 135))
        ...
        self.aibtn.setGeometry(QRect(1537,832,75,37))
        ...
        self.wishlist.setGeometry(QRect(1537,873,75,37))
        ...
        self.healthcareWidget.setStyleSheet('background-color: #009900; border-style: solid; border-color: white; border-width: 3px;')
        self.healthcarebaseWidth = 0
        self.healthcareextendedWidth = 390
        self.healthcareWidget.setGeometry(QRect(1275, 225, self.healthcarebaseWidth, 375))
        ...
        self.healthcare_gb1.setStyleSheet("QGroupBox { font: bold; font-size: 15px; margin-top: 4px; color: white; }"
        ...
        self.healthcare_gb1.setMaximumHeight(112)
        self.stress = QLabel()
        self.stress.setStyleSheet('color: white;'
                                'border-style: solid;'
                                'border-width: 4px;'
                                'border-color: white;')
        self.stress.setFont(QFont("맑은 고딕",15,QFont.Bold))
        self.stress.setMaximumHeight(75)
        ...
        self.healthcare_gb2.setStyleSheet("QGroupBox { font: bold; font-size: 15px; margin-top: 4px; color: white; }"
                                        "QGroupBox::title { subcontrol-origin:  margin; subcontrol-position: top left; padding: 0 10px 0 10px;}")
        ...
        self.healthcare_gb2.setMaximumHeight(225)

        #흑색종
        self.btnMelanoma = QPushButton()
        self.btnMelanoma.clicked.connect(self.DetectMelanoma)
        self.btnMelanoma.setFont(QFont("맑은 고딕",15,QFont.Bold))
        self.btnMelanoma.setText("흑색종 탐색")
        self.btnMelanoma.setStyleSheet("QPushButton { color: white; background-color: #66FF66; border-radius: 22px;}")
        self.btnMelanoma.setMaximumHeight(75)
        ...
        self.melanoma.setStyleSheet('color : white;'
                                ...
                                'border-color: white;' 
                                'border-radius: 37px;')
        self.melanoma.setFont(QFont("맑은 고딕",15,QFont.Bold))
        self.melanoma.setMaximumHeight( 75)
        ...
        self.airclenerextendedWidth = 375

        #Aircleaner ON/OFF
        self.aircleanerstate_Widget = QWidget(self.centralwidget)
        self.aircleanerstate_Widget
        self.aircleanerstate_Widget.setGeometry(QRect(1275, 225, self.aircleanerbaseWidth,127))
        ...
        self.aircleanerstate_ch.setFont(QFont("맑은 고딕",18,QFont.Bold))
        ...
        self.aircleanerOn_btn.setFont(QFont("맑은 고딕",18,QFont.Bold))
        self.aircleanerOn_btn.setMinimumSize(180,18)
        ...
        self.aircleanerOff_btn.setFont(QFont("맑은 고딕",18,QFont.Bold))
        self.aircleanerOff_btn.setMaximumWidth(180)
        ...
        self.aircleanerWidget.setGeometry(QRect(1275, 375, self.aircleanerbaseWidth,127))
        ...
        self.roomhumiditylabelName.setFont(QFont("맑은 고딕",18,QFont.Bold))
        ...
        self.roomhumiditylabel.setFont(QFont("맑은 고딕",18,QFont.Bold))
        ...
        self.mainbuttonWidget.setGeometry(QRect(1837,243,80,0))
        ...
        self.btnAircleanerShow.setMaximumHeight(45)
        self.btnAircleanerShow.setMaximumWidth(45)
        self.btnHealth.setMaximumHeight(45)
        self.btnHealth.setMaximumWidth(45)
        self.btnMakeUp.setMaximumHeight(45)
        self.btnMakeUp.setMaximumWidth(45)
        self.DisplayOff.setMaximumHeight(45)
        self.DisplayOff.setMaximumWidth(45)

        self.btnAircleanerShow.setIcon(aircleaner)
        self.btnAircleanerShow.setStyleSheet("QPushButton { background-color: #99CCFF; border-radius: 22px;}")
        self.btnAircleanerShow.setIconSize(QSize(33,33))
        self.btnHealth.setIcon(healthcare)
        self.btnHealth.setIconSize(QSize(33,33))
        self.btnHealth.setStyleSheet("QPushButton { background-color: #66FF66; border-radius: 22px;}")
        self.btnMakeUp.setIcon(makeup)
        self.btnMakeUp.setIconSize(QSize(33,33))
        self.btnMakeUp.setStyleSheet("QPushButton { background-color: #FF9999; border-radius: 22px;}")
        self.DisplayOff.setIcon(displayoff)
        self.DisplayOff.setIconSize(QSize(33,33))
        ...
        self.mainbuttinAni.setStartValue(QRect(QRect(1837,243,80,0)))
        self.mainbuttinAni.setEndValue(QRect(QRect(1837,243,80,412)))
    ...
    def DisplayOffFunc(self, detect_face_value):
    ...
    def healthcare(self, MainWindow):
        if self.btnHealth.isChecked():
            ...
            self.healthcareAni.setStartValue(QRect(1275, 225, self.healthcarebaseWidth,500))
            self.healthcareAni.setEndValue(QRect(1275, 225, self.healthcareextendedWidth,500))
            self.healthcareAni.start()
            self.btnHealth.setStyleSheet("QPushButton { background-color: #009900; border-radius: 22px;}")
            ...
            self.healthcareAni.setDuration(800)
            self.healthcareAni.setStartValue(QRect(1275, 225, self.healthcareextendedWidth,500))
            self.healthcareAni.setEndValue(QRect(1275, 225, self.healthcarebaseWidth,500))
            self.healthcareAni.start()
            self.btnHealth.setStyleSheet("QPushButton { background-color: #66FF66; border-radius: 22px;}")
    ...
    def AirCleanerFunc(self, MainWindow):
        if self.btnAircleanerShow.isChecked():
            ...
            self.aircleanerAni.setStartValue(QRect(1275, 352, self.aircleanerbaseWidth,127))
            self.aircleanerstate_Ani.setStartValue(QRect(1275, 225, self.aircleanerbaseWidth,97))
            self.aircleanerAni.setEndValue(QRect(1275, 352, self.airclenerextendedWidth,127))
            self.aircleanerstate_Ani.setEndValue(QRect(1275, 225, self.airclenerextendedWidth,97))
            self.aircleanerAni.start()
            self.aircleanerstate_Ani.start()


            self.btnAircleanerShow.setStyleSheet("QPushButton { background-color: #99FFFF; border-radius: 22px}")
            ...
            self.aircleanerAni.setDuration(800)
            self.aircleanerstate_Ani.setDuration(800)
            self.aircleanerAni.setStartValue(QRect(1275, 352, self.airclenerextendedWidth,127))
            self.aircleanerstate_Ani.setStartValue(QRect(1275, 225, self.airclenerextendedWidth,97))
            self.aircleanerAni.setEndValue(QRect(1275, 352, self.aircleanerbaseWidth,127))
            self.aircleanerstate_Ani.setEndValue(QRect(1275, 225, self.aircleanerbaseWidth,97))
            self.aircleanerAni.start()
            self.aircleanerstate_Ani.start()
    ...
    def SetWeatherFunc(self, temp, weathericon):
        ...
        # weathericon = weathericon.scaled(100, 100, Qt.IgnoreAspectRatio) # 이미지 크기 변경
        weathericon = weathericon.scaledToWidth(100) # 이미지 크기 변경
   ...
   #화장결과 숨기기 / 화장결과 보이기
    ...
    def makeupshow(self,MainWindow):
        ...
        if self.btnMakeUp.isChecked():
            ...
            self.face_maketabAni.setStartValue(QRect(1237, 225, self.face_maketabbaseWidth,600))
            # QRect(927, 168, self.face_maketabbaseWidth, 600)
            self.face_maketabAni.setEndValue(QRect(1237, 225, self.face_maketabextendedWidth,600))
            self.face_maketabAni.start()
            
            self.btnMakeUp.setStyleSheet("QPushButton { background-color: #FF6666; border-radius: 22px;}")
            ...
            self.face_maketabAni.setDuration(800)
            self.face_maketabAni.setStartValue(QRect(1237, 225, self.face_maketabextendedWidth,600))
            self.face_maketabAni.setEndValue(QRect(1237, 225, self.face_maketabbaseWidth,600))
            self.face_maketabAni.start()
            self.btnMakeUp.setStyleSheet("QPushButton { background-color: #FF9999; border-radius: 22px;}")
            # self.face_makeTab.hide()
            self.savebtn.hide()
    ...
    def openSaveWindow(self):
        ...
        self.saveAni.setStartValue(QRect(1312,825, self.saveloadbaseWidth, 135))
        self.saveAni.setEndValue(QRect(1312,825, self.saveloadextendedWidth, 135))
        self.saveAni.start()
        if self.savebtn.isChecked() == False:
            self.saveAni.setDuration(800)
            self.saveAni.setStartValue(QRect(1312,825, self.saveloadextendedWidth, 135))
            self.saveAni.setEndValue(QRect(1312,825, self.saveloadbaseWidth, 135))
            self.saveAni.start()
    ...
    def openLoadWindow(self):
        ...
        self.loadAin.setStartValue(QRect(1312, 825, self.saveloadbaseWidth, 135))
        self.loadAin.setEndValue(QRect(1312, 825, self.saveloadextendedWidth, 135))
        self.loadAin.start()
        if self.loadbtn.isChecked() == False:
            self.loadAin.setDuration(800)
            self.loadAin.setStartValue(QRect(1312, 825, self.saveloadextendedWidth, 135))
            self.loadAin.setEndValue(QRect(1312, 825, self.saveloadbaseWidth, 135))
            self.loadAin.start()
